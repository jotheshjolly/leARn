...
public class echoAR : MonoBehaviour
{
    ...
    private List<GameObject> gb1 = new List<GameObject>();
    ...
    /* void Start()
     {
         ...
         try
         {
             ...
             //StartCoroutine(QueryDatabase(serverURL + "&entry=31f74013-cf74-4d7f-b858-34c42e3532bf"));
         }
    ...
    public void TigerKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=8c5ac566-4480-4f20-a867-f00ed9a56724"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void WolfKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=ddc66183-51e3-419c-947e-94e8c60a117b"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void CowKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=2230e454-4126-4133-a284-09eb3fe8b477"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void BearKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=e48e5e9e-4194-4c66-9475-7eb376e9aa24"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void Carkey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=c8377ccb-4fa3-47ad-963f-b93ab0bcf7b4"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void BusKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=e52edd45-1629-46cd-ab5e-9cf485c8c1bf"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void Vankey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=4a6ef10a-f413-404a-a046-a69225646e34"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void TruckKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=3967f880-92cf-4927-8759-e65e1ccee9a1"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void BikeKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=63a0238c-8451-4a4d-8566-12cbb6f1c553"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void ParrotKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=53d36a7c-2fd3-4b4e-a119-02b0f988ee32"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void PenguinKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=c3fd8f14-9ba7-4030-9697-a1bc8bb1d7de"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void SparrowKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=9bd75952-ef36-46ce-8b70-fa24de4f72dd"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void roosterKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=c9c5544c-235f-4dbb-bc48-784817ed8839"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void TurkeyKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=7a53d95f-f239-4120-92e1-5082cc6ea233"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void DroneKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=1c07beb1-345d-43e5-9a89-cd07ed029514"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void HeliKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=69493826-0e42-4813-837c-d00ec201f35f"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void FJKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=f853d590-dcd6-48f0-98ca-111fb8942bc2"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void RocketKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=802e941c-aae1-484c-b59e-49b4e1a91205"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void AppleKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=86474473-11ba-46f5-a88f-c1f099b45446"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void BananaKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=eab8a389-63ce-4b86-affd-cdb7d9e8b825"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void PineKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=9627b899-c4a1-46a6-baba-40bffbfe5011"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void PalmKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=8e38984a-9d28-49d6-be6c-eabe66e5a4fc"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void BosaiKey()
    {
        ...
        try
        {
            ...
            //StartCoroutine(QueryDatabase(serverURL));
            // What to query a single entry? Replace the above line with:
            StartCoroutine(QueryDatabase(serverURL + "&entry=a0029310-ed83-4c50-a00d-f1d6a42d62fc"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
